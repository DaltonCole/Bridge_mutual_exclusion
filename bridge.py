...
class Bridge:
    ...
    def make_menus(self):
        ...
        count_button = Button(self.root, text='Set Person Count', command=lambda: self.set_count(default_count.get()))
    ...
    def make_people(self):
        ...
        for i in range(self.count):
            ...
            shape = self.canvas.create_oval(
                    (sp[0] - self.c_size, sp[1] + self.c_size, sp[0] + self.c_size, sp[1] - self.c_size),
                    fill=random_color())
    ...
    def move_people(self):
        ...
        try:
            for i in self.people:
                ...
                elif 350 - self.c_size > coords[0] > 100 - self.c_size and coords[1] < 250 - self.c_size:
                ...
                # 7 #
                # Move across bride
                elif 650 - self.c_size > coords[0] > 350 - self.c_size and coords[1] == 250 - self.c_size:
                    # 3 #
                    # Going East
                    if i.side == 1:
                ...
                elif 900 - self.c_size > coords[0] > 650 - self.c_size and coords[1] < 250 - self.c_size:
                ...
                # Head towards right side of bridge
                    ...
                    # Go partial distance if close to (650, 250):
                        ...
                        self.canvas.move(i.person, -(coords[0] - (650 - self.c_size)),
                                         -(coords[1] - (250 - self.c_size)))
                        i.set_side(0)
    ...
    def bridge_single_person(self, person):
        ...
        for i in self.people:
            ...
            coords = self.canvas.coords(i.person)
            if 650 - self.c_size > coords[0] > 350 - self.c_size:
                return False
...
def random_color():
    ...
    return '#' + choice(hex_colors) + choice(hex_colors) + choice(hex_colors) + choice(hex_colors) + \
           choice(hex_colors) + choice(hex_colors)
